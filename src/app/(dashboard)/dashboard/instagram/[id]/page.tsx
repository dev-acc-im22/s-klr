...
export default function EditInstagramAutomationPage({ params }: { params: Promise<{ id: string }> }) {
  const { id } = use(params);
    ...
    <div className="space-y-6 max-w-3xl mx-auto">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Update your automated DM settings
            </p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex items-center justify-end gap-4 mt-6">
            ...
            <Button type="submit" disabled={saving || !formData.name || !formData.triggerType || !formData.message}>
